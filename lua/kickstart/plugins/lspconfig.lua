...
return {
  ...
  },
  {
    ...
    config = function()
      ...
      -- Configure global LSP capabilities (shared by all servers)
      vim.lsp.config('*', {
        capabilities = capabilities,
      })

      -- Enable Language Servers using the native vim.lsp workflow
      -- Server-specific configurations are in lsp/ directory
      vim.lsp.enable({
        'lua_ls',
        'jsonls',
        'css_variables',
